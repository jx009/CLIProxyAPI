...
func GetOpenAIModels() []*ModelInfo {
	return []*ModelInfo{
		...
		},
		{
			...
			Version:             "gpt-5.4",
			DisplayName:         "GPT 5.4",
			Description:         "Latest generation of GPT 5 series with enhanced reasoning and coding capabilities.",
		...
		},
		{
			...
			Description:         "Professional version of GPT 5.4 with advanced reasoning and extended context capabilities.",
